...
def home(request):
	...
	return render(request, 'historical_validation_tool_venezuela/home.html', context)
...
def get_popup_response(request):
	...
	try:
		...
		'''Get Observed Data'''
		url = 'https://www.hydroshare.org/resource/6d6104665e4842d4b58035066bb34fa0/data/contents/{0}_{1}.csv'.format(codEstacion, nomEstacion)
...
def get_hydrographs(request):
	...
	try:
		...
		return render(request, 'historical_validation_tool_venezuela/gizmo_ajax.html', context)
